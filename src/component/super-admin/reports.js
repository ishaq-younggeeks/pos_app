                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav nav-pills">
                                    <li class="width1" style={{font_size: "12px"}}><a href="active-reports.js" style={{padding: "10px"}}>Active Reports</a></li>
                                    <li class="active width1" style={{font_size: "12px"}}><a href="all-reports.html" style={{padding: "10px"}}>All Reports</a></li>
                                </ul>
