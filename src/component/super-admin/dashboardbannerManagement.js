            ...
            <div>
                <div class="content-wrapper">
                    <section class="content-header">
                        <h1>Dashboard Banner Management</h1>
                    </section>
                    <section class="content">
                        <div class="row">
                            <div class="col-md-12 col-xs-12">
                                <ul class="nav nav-pills">
                                    <li class=" width1" style={{font_size: "12px"}}><Link to="consumer-banner-management" style={{padding: "10px"}}>Consumer Banner</Link></li>
                                    <li class="active width1" style={{font_size: "12px"}}><Link to="dashboard-banner-management" style={{padding: "10px"}}>Dashboard Banner</Link></li>
                                </ul>
