...
class RestaurantReportModal extends Component {
    render() { 
        return (
            <React.Fragment>
                ...
                <div className="modal-content">
                    <div className="modal-header">
                        ...
                        <h4 className="modal-title">
                            <img src={process.env.PUBLIC_URL + "/restaurant/images/mcd.png"} alt="MCD" width="40" style={{borderRadius: '4px'}}/>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style={{borderTop: '0px',verticalAlign: 'middle'}}>
                                    <a href="#"><img src={process.env.PUBLIC_URL + "/restaurant/images/attach.png"} alt="Attach"/></a>
                                </td>
                            </tr>
                            <tr>
