...
class Promotion extends Component {
    ...
    formSubmit(event,id){
        // const req_question = document.getElementsByName('eating_opt');  
        // if (!req_question.uncheck) {            
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="thumbnail">
                                ...
                                <div className="col-md-12">
                                    <form data-toggle="validator" novalidate="true" className="form-horizontal" onSubmit={(e) =>this.formSubmit(e,this.state.id)}>
                                        <div className="row">
                                            <div className="col-xs-6">
                                                <div className="form-group">
                                                    <label className="col-sm-3 control-label">Name</label>
                                                    <div className="col-sm-9">
                                                        <input type="text" name="name" defaultValue={this.state.editName} onChange={this.onChange} className="form-control input-sm" placeholder="Name" data-error="Please Enter a valid Name" required/>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="col-sm-9">
                                                        <input type="text"  name="description" defaultValue={this.state.editDescriptiion} onChange={this.onChange} className="form-control input-sm" placeholder="Description" required/>
                                                        <div class="help-block with-errors"></div> 
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    ...
                                                    <div className="col-sm-9">
                                                        <input type="text" name="price" defaultValue={this.state.editPrice} onChange={this.onChange}  className="form-control input-sm" placeholder="Price" required/>
                                                        <div class="help-block with-errors"></div> 
                                                    </div>
                                                </div>
                                                <div className="form-group" id="refresh">
                                                    ...
                                                    <div className="col-sm-9">
                                                        <label className="checkbox-inline">                                                                                                                    
                                                            { this.state.editEatingOpt[0]=='Delivery' ?
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    <div className="col-sm-9">
                                                        <span className="btn btn-warning btn-sm btn-block fileinput-button">
                                                            ...
                                                            {this.state.showLogoImage ? 
                                                            <input type="file" id="promoImage" name="image" onChange={this.onLogo}  style={fileInpuButtonInput} />
                                                            :
                                                            <input type="file" id="promoImage" name="image" onChange={this.onLogo}  style={fileInpuButtonInput} required/>
                                                            }
                                                        </span>
                                            ...
                                            <div className="col-xs-6">
                                                <div className="form-group">
                                                    ...
                                                    <div className="col-sm-8">
                                                        <div className="input-group input-group-sm">
                                                            ...
                                                            {this.state.myToggle === 0 ? <input type="time" className="form-control"  name="timing_from"  id="timing_from" onChange={this.onTimingFrom} placeholder="Hour" style={{borderRadius: '0px'}} required/>:<input type="time" className="form-control" name="timing_from" id="timing_from" defaultValue={this.state.editTimingFrom} onChange={this.onTimingFrom} placeholder="Hour" style={{borderRadius: '0px'}} required/>}
                                                            <span className="input-group-addon" style={{borderLeft:'0px',borderRight: '0px'}}>To</span>
                                                            {this.state.myToggle === 0 ? <input type="time" className="form-control"  name="timing_to" id="timing_to" onChange={this.onTimingTo} placeholder="Hour" style={{borderRadius: '0px'}} required/>:<input type="time" className="form-control" name="timing_to" id="timing_to" defaultValue={this.state.editTimingTo} onChange={this.onTimingTo} placeholder="Hour" style={{borderRadius: '0px'}}required/>}
                                                        </div>
                                                    </div>
                                                    <div class="help-block with-errors"></div> 
                                                </div>
                                                <div className="form-group">
                                                    ...
                                                    <div className="col-sm-8">
                                                        <div className="input-group input-group-sm">
                                                            <span className="input-group-addon">From</span>
                                                            {this.state.myToggle === 0 ? <input type="date" className="form-control" name="date_from" onChange={this.onChange} placeholder="Date" style={{borderRadius: '0px'}} required/> : <input type="date" className="form-control" name="date_from" defaultValue = {this.state.editDateFrom} onChange={this.onChange} placeholder="Date" style={{borderRadius: '0px'}} required/>}
                                                            <span className="input-group-addon" style={{borderLeft:'0px',borderRight: '0px'}}>To</span>
                                                            {this.state.myToggle === 0 ? <input type="date" className="form-control" name="date_to" onChange={this.onChange} placeholder="Date" style={{borderRadius: '0px'}}required/> : <input type="date" className="form-control" name="date_to" defaultValue = {this.state.editDateTo} onChange={this.onChange} placeholder="Date" style={{borderRadius: '0px'}} required/>}
                                                        </div>
                                                    </div>
                                                    <div class="help-block with-errors"></div> 
                                                </div>
